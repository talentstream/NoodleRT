...
//    const auto imageWidth = GetWidth();
//    const auto imageHeight = GetHeight();
...
Integer Renderer::GetWidth() const {
    return pScene->GetIntegrator()->GetCamera()->GetFilm()->width;
}

Integer Renderer::GetHeight() const {
    return pScene->GetIntegrator()->GetCamera()->GetFilm()->height;
}
